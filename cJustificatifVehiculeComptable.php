...
$mois = date('Ym');
$idVisiteur=$_GET['id'];
$requete = obtenirInfoVH($idConnexion, $idVisiteur);
...
if(isset($idVehi)){
          ...
          $nbFichier = 0;
          $dir = 'C:/wamp64/www/appli_frais/upload/Vehicule/'.$idVisiteur."/".$idVehi."/";
          ...
          if($dossier = opendir($dir)){
            ...
            while(false !== ($fichier = readdir($dossier))){
              if($fichier !='.' && $fichier !='..' && $fichier != 'index.php'){
                ...
                <td><h2><a href="?delete=<?php echo $path_file;?>">Refuser</a> </h2>
